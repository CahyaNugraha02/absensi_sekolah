<?php if ($this->session->userdata('logged_in') == true) : ?>
    ...
    <head>
        ...
        <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url('assets'); ?>/assets/img/smk.png">
        <link rel="icon" type="image/png" href="<?= (empty($dataapp['logo_instansi'])) ? base_url('assets/img/smk.png') : (($dataapp['logo_instansi'] == 'default-logo.png') ? base_url('assets/img/smk.png') : base_url('storage/setting/' . $dataapp['logo_instansi'])); ?>">
        <meta name="description" content="" />
        <meta name="author" content="" />
        <title>E-Presensi SMK PERMATA</title>
