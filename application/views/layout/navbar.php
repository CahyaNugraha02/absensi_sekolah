<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand truncate" href="<?= base_url(''); ?>"><?= $appname = (empty($dataapp['nama_app_absensi'])) ? 'E-Presensi SMK PERMATA' : $dataapp['nama_app_absensi']; ?></td></a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button><!-- Navbar Search-->
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                ...
                <h6 class="dropdown-header">
                    <div class="mr-1 d-inline">Posisi:</div><?= $user['jabatan'] ?>
                </h6>
                <h6 class="dropdown-header">
                    <div class="mr-1 d-inline">Kode:</div><?= $user['kode_akun'] ?>
                </h6>
