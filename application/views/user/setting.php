                    ...
                    <div class="tab-content mt-3">
                        <div class="tab-pane active" id="setelan" role="tabpanel">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="username_pegawai" name="username_pegawai" value="<?= $user['username']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="mapel" class="col-sm-4 col-form-label">Guru Mapel</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="mapel" name="mapel" value="<?= $user['mapel']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nomer_induk" name="nomer_induk" value="<?= $user['nomer_induk']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
