        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 align-self-center">
                <div class="text-center my-2">
                    <img src="<?= $logo_source = (empty($dataapp['logo_instansi'])) ? base_url('assets/img/smk.png') : (($dataapp['logo_instansi'] == 'default-logo.png') ? base_url('assets/img/smk.png') : base_url('storage/setting/'.$dataapp['logo_instansi'])); ?>"
                        class="card-img" style="width:50%;">
                    <h3 class="text-white">
                        <?= $appname = (empty($dataapp['nama_app_absensi'])) ? 'E-Presensi SMK PERMATA' : $dataapp['nama_app_absensi']; ?>
                    </h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox"><input class="custom-control-input"
                                    id="rememberme" type="checkbox" name="rememberme" /><label
                                    class="custom-control-label" for="rememberme">Remember Me</label></div>
                        </div>
                        <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><button
                                type="submit" class="btn btn-primary"><span
                                    class="fas fa-fw fa-sign-in-alt mr-2"></span>Login</button></div>
                        </form>
                        <hr>
                        <div class="container">
                            <div class="d-flex align-items-center justify-content-center small">
                                <div class="text-muted">Copyright &copy;
                                    <?= date("Y"); ?><a href="<?= base_url(); ?>" class="ml-1">
                                        <?= $appname = (empty($dataapp['nama_app_absensi'])) ? 'E-Presensi SMK PERMATA' : $dataapp['nama_app_absensi']; ?>
                                    </a>
                                    <div class="d-inline">Powered By<a href="" class="ml-1">PembasmiTugas</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
