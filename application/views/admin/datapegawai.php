<div class="container-fluid">
    <h1 class="my-4"><span class="fas fa-user-tie mr-2"></span>Data Siswa & Guru</h1>
    <div class="card mb-4">
        <div class="card-header">
            <div class="float-right">
                <div class="btn btn-primary" id="refresh-tabel-pegawai"><span class="fas fa-sync-alt mr-1"></span>Refresh Tabel</div>
                <button class="btn btn-success" data-toggle="modal" data-target="#addpegawaimodal" id="pgwadduser"><span class="fas fa-user-plus mr-1"></span>Tambah Data</button>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="addpegawaimodallabel"><span class="fas fa-user-plus mr-1"></span>Tambah Siswa / Guru</h5>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="jabatan_pegawai" class="col-sm-4 col-form-label">Posisi</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="jabatan_pegawai" name="jabatan_pegawai">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="instansi_pegawai" class="col-sm-4 col-form-label">Sekolah</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="instansi_pegawai" name="instansi_pegawai" value="<?= $nameinstansiset = (empty($dataapp['nama_instansi'])) ? '[Nama Instansi Belum Disetting]' : $dataapp['nama_instansi']; ?>" data-toggle="tooltip" data-placement="top" title="Untuk mengubah nama sekolah ini silakan buka pada bagian setting aplikasi" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nomer_induk" class="col-sm-4 col-form-label">Nomer Induk</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="mata_pelajaran" class="col-sm-4 col-form-label">Guru Mapel</label>
                    <div class="col-sm-8">
                        <div class="input-group">
                ...
                <div class="form-group row">
                    <label for="kelas_siswa" class="col-sm-4 col-form-label">Kelas Siswa</label>
                    <div class="col-sm-8">
                        <div class="input-group">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <?= form_dropdown('role_pegawai', ['' => 'Select Role', 1 => 'Administrator', 2 => 'Guru', 3 => 'Siswa'], set_value('role_pegawai'), 'class="form-control" id="role_pegawai"'); ?>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label for="verifikasi_pegawai" class="col-sm-4 col-form-label">Status</label>
                    <div class="col-sm-8">
                        <div class="form-check form-check-inline">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">Pas Foto</div>
                    <div class="col-sm-8">
...
<div class="modal fade" id="viewpegawaimodal" tabindex="-1" role="dialog" aria-labelledby="viewpegawaimodal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="viewpegawaimodallabel"><span class="fas fa-user-tie mr-1"></span>Preview Siswa & Guru</h5>
            </div>
            <div class="modal-body">
...
<div class="modal fade" id="editpegawaimodal" tabindex="-1" role="dialog" aria-labelledby="editpegawaimodal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="editpegawaimodallabel"><span class="fas fa-user-edit mr-1"></span>Edit</h5>
            </div>
            <div class="modal-body">
