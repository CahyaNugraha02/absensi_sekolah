<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary text-white mb-4">
                <div class="card-body">
                    <h4><span class="fas fa-user-tie mr-2"></span>Jumlah Siswa & Guru</h4>
                    <h6 class="mt-3"><?= $jmlpegawai ?><div class="d-inline ml-1">Siswa & Guru</div>
                    </h6>
                </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-danger text-white mb-4">
                <div class="card-body">
                    ...
                    <h6 class="mt-3"><?= $pegawaitelat ?><div class="d-inline ml-1">Siswa & Guru
                        </div>
                    </h6>
                </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success text-white mb-4">
                <div class="card-body">
                    ...
                    <h6 class="mt-3"><?= $pegawaimasuk ?><div class="d-inline ml-1">Siswa & Guru</div>
                    </h6>
                </div>
                <div class="card-footer small">
                    <div class="text-white">Data Hari Ini</div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card mb-4">
                <div class="card-header"><span class="fas fa-user-clock mr-1"></span>Daftar Siswa & Guru Terlambat [Hari Ini]
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-6">
            <div class="card mb-4">
                <div class="card-header"><span class="fas fa-user-check mr-1"></span>Daftar Siswa & Guru Hadir [Hari Ini]
                </div>
                <div class="card-body">
                    <div class="table-responsive">
