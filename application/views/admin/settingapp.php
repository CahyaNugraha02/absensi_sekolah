                ...
                <?php else : ?>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="nama_instansi" class="col-sm-4 col-form-label">Nama Sekolah</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama_instansi" name="nama_instansi" value="<?= $nameinstansiset = (empty($dataapp['nama_instansi'])) ? '[Nama Sekolah Belum Disetting]' : $dataapp['nama_instansi']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nama_app_absen" name="nama_app_absen" value="<?= $nameapp = (empty($dataapp['nama_app_absensi'])) ? 'Nama App' : $dataapp['nama_app_absensi']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
